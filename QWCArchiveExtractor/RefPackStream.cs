...
namespace OpenSage.FileFormats.RefPack
{
    class RefPackStream : Stream
    {
        ...
        public RefPackStream(Stream compressedStream)
        {
            ...
            // For whatever reason, QWC uses static 0x15 value for all headers
            if (headerByte1 != 0b00010101)
            {
                throw new InvalidDataException();
            }

            // Appears to be fixed settings for QWC
            var largeFilesFlag = true;
